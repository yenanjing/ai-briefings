...
### 2🌟 How Transformers Learn to Plan via Multi-Token Prediction
- **机构**: 未知
...
### 3🌟 Sample Complexity of Autoregressive Reasoning: Chain-of-Thought vs. End-to-End
- **机构**: 未知
...
### 4🌟 The Long-Horizon Task Mirage? Diagnosing Where and Why Agentic Systems Break
...
### 6🌟 M*: Every Task Deserves Its Own Memory Harness
...
### 8🌟 Filtered Reasoning Score: Evaluating Reasoning Quality on a Model's Most-Confident Traces
- **机构**: 未知（Amy Zhang 参与）
...
### 9🌟 AlphaEval: Evaluating Agents in Production
...
### 10🌟 QuarkMedSearch: A Long-Horizon Deep Search Agent for Exploring Medical Intelligence
...
### 11🌟 Beyond Scores: Diagnostic LLM Evaluation via Fine-Grained Abilities
- **机构**: 未知
...
### 12🌟 GAM: Hierarchical Graph-based Agentic Memory for LLM Agents
...
### 13🌟 Aethon: A Reference-Based Replication Primitive for Constant-Time Instantiation of Stateful AI Agents
- **机构**: 未知
...
### 14🌟 Latent patterns of urban mixing in mobility analysis across five global cities
...
### 15🌟 CascadeDebate: Multi-Agent Deliberation for Cost-Aware LLM Cascades
- **机构**: 未知
...
### 16🌟 SubFlow: Sub-mode Conditioned Flow Matching for Diverse One-Step Generation
- **机构**: 未知
...
### 17🌟 Polynomial Expansion Rank Adaptation: Enhancing Low-Rank Fine-Tuning with High-Order Interactions
- **机构**: 未知
...
### 18🌟 Socrates Loss: Unifying Confidence Calibration and Classification
- **机构**: 未知
...
### 20🌟 Identity as Attractor: Geometric Evidence for Persistent Agent Architecture in LLM Activation Space
- **机构**: 未知
...
### 21🌟 NaviRAG: Towards Active Knowledge Navigation for Retrieval-Augmented Generation
- **机构**: 未知
...
### 22🌟 Preventing Safety Drift in Large Language Models via Coupled Weight and Activation Constraints
- **机构**: 未知
...
### 24🌟 MolMem: Memory-Augmented Agentic Reinforcement Learning for Sample-Efficient Molecular Optimization
- **机构**: 未知
...
### 25🌟 Self-Distillation Zero: Self-Revision Turns Binary Rewards into Dense Supervision
- **机构**: 未知
...
### 26🌟 Ride the Wave: Precision-Allocated Sparse Attention for Smooth Video Generation
- **机构**: 未知
...
### 27🌟 ReflectCAP: Detailed Image Captioning with Reflective Memory
- **机构**: 未知
...
### 28🌟 Cycle-Consistent Search: Question Reconstructability as a Proxy Reward for Search Agent Training
- **机构**: 未知
...
### 29🌟 GoodPoint: Learning Constructive Scientific Paper Feedback from Author Responses
- **机构**: 未知
