...
### 5🌟 Generation Is Compression: Zero-Shot Video Coding via Stochastic Rectified Flow
...
### 6🌟 Make Geometry Matter for Spatial Reasoning
...
### 7🌟 When Perplexity Lies: Generation-Focused Distillation of Hybrid Sequence Models
...
### 8🌟 Machine Unlearning under Retain-Forget Entanglement
...
### 10🌟 Weight Tying Biases Token Embeddings Towards the Output Space
...
### 11🌟 MemBoost: A Memory-Boosted Framework for Cost-Aware LLM Inference
...
### 12🌟 Ruka-v2: Tendon Driven Open-Source Dexterous Hand with Wrist and Abduction for Robot Learning
...
### 13🌟 Zero-Shot Depth from Defocus
...
### 14🌟 Tunable Soft Equivariance with Guarantees
...
### 15🌟 Beyond MACs: Hardware Efficient Architecture Design for Vision Backbones
- **作者**: （截断）
