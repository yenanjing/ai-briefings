...
### 3🌟 Rethinking Language Model Scaling under Transferable Hypersphere Optimization
...
### 8🌟 On-the-fly Repulsion in the Contextual Space for Rich Diversity in Diffusion Transformers
...
### 10🌟 HandX: Scaling Bimanual Motion and Interaction Generation
...
### 11🌟 Stepwise Credit Assignment for GRPO on Flow-Matching Models
...
### 12🌟 Stop Probing, Start Coding: Why Linear Probes and Sparse Autoencoders Fail at Compositional Generalisation
...
### 14🌟 AdaptToken: Entropy-based Adaptive Token Selection for MLLM Long Video Understanding
...
### 15🌟 SonoWorld: From One Image to a 3D Audio-Visual Scene
