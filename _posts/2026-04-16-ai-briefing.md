...
### 2🌟 Prism: Symbolic Superoptimization of Tensor Programs
...
### 3🌟 MM-WebAgent: A Hierarchical Multimodal Web Agent for Webpage Generation
- **机构**: 微软亚洲研究院
...
### 6🌟 TokenLight: Precise Lighting Control in Images using Attribute Tokens
...
### 9🌟 Generalization in LLM Problem Solving: The Case of the Shortest Path
...
### 11🌟 Context Over Content: Exposing Evaluation Faking in Automated Judges
...
### 12🌟 LeapAlign: Post-Training Flow Matching Models at Any Generation Step by Building Two-Step Trajectories
- **机构**: UTS / 清华大学
...
### 15🌟 From Tokens to Steps: Verification-Aware Speculative Decoding for Efficient Multi-Step Reasoning
