...
- **机构**: 未知机构（项目页: gen-searcher.vercel.app，代码: github.com/tulerfeng/Gen-Searcher）
...
- **机构**: University of Minnesota（推测 Rui Zhang 所在机构）
...
- **机构**: ETH Zurich / Microsoft（推测，基于 Marc Pollefeys 和 Alexander Mathis 机构背景）
...
**机构**
[[MIT]] [[Microsoft]] [[中国科学院]] [[Meta Reality Labs]] [[ETH Zurich]] [[Tel Aviv University]] [[Mila]] [[UIUC]]
