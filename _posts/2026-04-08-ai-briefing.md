...
### 2🌟 Gym-Anything: Turn any Software into an Agent Environment
...
### 8🌟 Toward Consistent World Models with Multi-Token Prediction and Latent Semantic Enhancement
- **机构**: 华为诺亚方舟实验室
...
### 10🌟 HaloProbe: Bayesian Detection and Mitigation of Object Hallucinations in VLMs
- **机构**: Allen AI & UW
...
### 11🌟 DiffHDR: Re-Exposing LDR Videos with Video Diffusion Models
- **机构**: 腾讯 & USC
...
### 12🌟 ACE-Bench: Agent Configurable Evaluation
- **机构**: 未知机构
...
### 14🌟 LLM4CodeRE: Generative AI for Code Decompilation
...
### 15🌟 SEM-ROVER: Semantic Voxel-Guided Diffusion for Driving Scene Generation
- **机构**: COSYS & 巴黎天文台
