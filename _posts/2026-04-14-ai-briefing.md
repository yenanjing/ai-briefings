...
### 6🌟 SWE-AGILE: A Software Agent Framework for Efficiently Managing Dynamic Reasoning Context
- **机构**: 厦门大学、微软
...
### 8🌟 ClawGuard: A Runtime Security Framework for Tool-Augmented LLM Agents Against Indirect Prompt Injection
- **机构**: 新加坡管理大学
...
### 11🌟 LangFlow: Continuous Diffusion Rivals Discrete in Language Modeling
- **机构**: 未知机构
...
### 12🌟 General365: Benchmarking General Reasoning in Large Language Models
- **机构**: 中国科学院大学、美团
...
### 13🌟 Grounded World Model for Semantically Generalizable Planning
- **机构**: NUS 新加坡国立大学、EPFL
...
### 14🌟 HDR Video Generation via Latent Alignment with Logarithmic Encoding
...
### 15🌟 C-ReD: Chinese Benchmark for AI-Generated Text Detection
- **机构**: 清华大学（深圳国际研究生院）
...
### 16🌟 SyncFix: Fixing 3D Reconstructions via Multi-View Synchronization
- **机构**: 未知机构
...
### 17🌟 LMMs Meet Object-Centric Vision
- **机构**: 浙江大学、南京航空航天大学
...
### 18🌟 Disentangled Point Diffusion for Precise Object Placement
- **机构**: 未知机构（可能为 CMU）
...
### 19🌟 Psychological Concept Neurons in LLMs
- **机构**: 未知机构
...
### 20🌟 HistLens: Mapping Idea Change across Concepts and Corpora
- **机构**: 北京大学
...
### 21🌟 Evaluating Cooperation in LLM Social Groups through Elected Leadership
- **机构**: 未知机构（DeepMind 线索）
...
### 22🌟 Re2Pix: Representations Before Pixels
- **机构**: 未知机构
...
### 23🌟 Pair2Scene: Learning Local Object Relations for Procedural Scene Generation
- **机构**: 未知机构
...
### 24🌟 GenTac: Generative Modeling and Forecasting of Soccer Tactics
- **机构**: 未知机构
...
### 25🌟 Multi-ORFT: Stable Online RL Fine-Tuning for Multi-Agent Diffusion Planning
- **机构**: 未知机构
...
### 26🌟 Discourse Diversity in Multi-Turn Empathic Dialogue
- **机构**: 未知机构
...
### 27🌟 Collaborative Multi-Agent Scripts for Murder Mystery Games
- **机构**: 中山大学、香港中文大学（深圳）
...
### 28🌟 Fairness is Not Flat: Geometric Phase Transitions Against Shortcut Learning
- **机构**: 未知机构
...
### 30🌟 Physics-Informed State Space Models for Solar Irradiance Forecasting
- **机构**: 未知机构（单作者）
...
### 31🌟 Learning Long-term Motion Embeddings for Efficient Kinematics Generation
- **机构**: 未知机构
