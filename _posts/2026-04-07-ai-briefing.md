...
### 1🌟 Vero: An Open RL Recipe for General Visual Reasoning
...
### 2🌟 QED-Nano: Teaching a Tiny Model to Prove Hard Theorems
- **机构**: LM-Provers (多位合作者)
...
### 5🌟 LoMa: Local Feature Matching Revisited
...
### 6🌟 Vanast: Virtual Try-On with Human Image Animation via Synthetic Triplet Supervision
...
### 8🌟 How AI Aggregation Affects Knowledge
...
### 10🌟 Muon Dynamics as a Spectral Wasserstein Flow
...
### 13🌟 Synthetic Sandbox for Training Machine Learning Engineering Agents
...
### 14🌟 MemMachine: A Ground-Truth-Preserving Memory System for Personalized AI Agents
...
### 15🌟 Rethinking Model Efficiency: Multi-Agent Inference with Large Models
- **机构**: 未知机构
...
### 16🌟 SkillX: Automatically Constructing Skill Knowledge Bases for Agents
...
### 17🌟 DIRECT: Video Mashup Creation via Hierarchical Multi-Agent Planning
- **机构**: 未知机构
...
### 18🌟 Beyond the Final Actor: Modeling Creator and Editor Roles for LLM Text Detection
...
### 19🌟 E-VLA: Event-Augmented Vision-Language-Action Model
...
### 21🌟 Fully Procedural Synthetic Data from Simple Rules for Multi-View Stereo
...
### 22🌟 HorizonWeaver: Generalizable Multi-Level Semantic Editing for Driving Scenes
- **机构**: 未知机构
...
### 23🌟 PointTPA: Dynamic Network Parameter Adaptation for 3D Scene Understanding
...
### 24🌟 ANX: Protocol-First Design for AI Agent Interaction
- **机构**: 个人作者 (Xu Mingze)
- **作者**: Xu Mingze
...
### 25🌟 Rethinking Exploration in RLVR: AsymGRPO
- **机构**: 未知机构
...
### 26🌟 LiveFact: A Dynamic, Time-Aware Benchmark for Fake News Detection
- **机构**: 未知机构
...
### 27🌟 Free-Range Gaussians: Non-Grid-Aligned Generative 3D Gaussian Reconstruction
- **机构**: 多机构合作
...
### 28🌟 Beyond Global Scores: Fine-Grained Token Grounding for LVLM Hallucination Detection
- **机构**: 多机构合作
...
### 29🌟 Agentic Federated Learning: The Future of Distributed Training
