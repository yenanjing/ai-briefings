...
### 1🌟 ASI-Evolve: AI Accelerates AI
...
### 4🌟 Training-Free Dynamic Upcycling of Expert Language Models (DUME)
- **机构**: Gensyn
...
### 6🌟 PRoSFI: Learning to Generate Formally Verifiable Step-by-Step Logic Reasoning
...
### 8🌟 CG-LoRA: Curvature-Guided LoRA Steering in the Pretrained NTK Subspace
...
### 10🌟 AgentFixer: From Failure Detection to Fix Recommendations in LLM Agentic Systems
- **机构**: IBM Research（Israel）
