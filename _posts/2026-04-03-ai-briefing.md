...
### 2🌟 Large-scale Codec Avatars: The Unreasonable Effectiveness of Large-scale Avatar Pretraining
- **机构**: Meta Reality Labs
...
### 5🌟 STOP: Steerable Visual Representations
- **机构**: 未知机构
...
### 8🌟 Grounded Token Initialization for New Vocabulary in LMs for Generative Recommendation
- **机构**: 未知机构
...
### 9🌟 EventHub: Data Factory for Generalizable Event-Based Stereo Networks without Active Sensors
- **机构**: 未知机构
...
### 12🌟 MetaNav: Stop Wandering - Efficient Vision-Language Navigation via Metacognitive Reasoning
- **机构**: 未知机构
...
### 13🌟 A Simple Baseline for Streaming Video Understanding
- **机构**: 南洋理工大学
...
### 14🌟 No Single Best Model for Diversity: Learning a Router for Sample Diversity
- **机构**: 华盛顿大学
...
### 16🌟 Crystalite: A Lightweight Transformer for Efficient Crystal Modeling
- **机构**: 未知机构
...
### 17🌟 The Self Driving Portfolio: Agentic Architecture for Institutional Asset Management
- **机构**: 未知机构
...
### 18🌟 De Jure: Iterative LLM Self-Refinement for Structured Extraction of Regulatory Rules
- **机构**: 未知机构
...
### 20🌟 Topological Effects in Neural Network Field Theory
- **机构**: 未知机构
